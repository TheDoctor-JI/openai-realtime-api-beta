...
export class RosInterface {
  ...
  constructor() {
    ...
    /**
     * Parse for prompts to GPT4o realtime
     */
    try{
      var sleep_cond_prompt_database = File.readFile("configs/experiment_questionnaire_database.yml", {
          encoding: "utf8",
        });
      // var parsed_database = yamlParse(sleep_cond_prompt_database);
    }
    catch (error) {
