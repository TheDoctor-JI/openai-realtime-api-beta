...
export class RealtimeAPI extends RealtimeEventHandler {
  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    ...
    this.default_model = 'gpt-4o-realtime-preview-2024-12-17'

    this.defaultUrl = `https://grace-m6619j2p-swedencentral.openai.azure.com/openai/realtime?api-version=2024-10-01-preview&deployment=4orealtime_swedencentral` + `&api-key=${this.apiKey}`,
    this.default_protocols = []

    // this.defaultUrl = 'https://api.openai-proxy.org/v1/realtime?model=' + this.default_model;
    // this.default_protocols =         [
    //   'realtime',
   ...
   */
  async connect({ model } = { model: this.default_model }) {
