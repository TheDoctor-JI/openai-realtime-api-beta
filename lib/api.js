...
export class RealtimeAPI extends RealtimeEventHandler {
  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    ...
    this.defaultUrl = `https://grace-m6619j2p-swedencentral.openai.azure.com/openai/realtime?api-version=2024-10-01-preview&deployment=${this.default_model}` + `&api-key=${this.apiKey}`,
