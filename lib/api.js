...
export class RealtimeAPI extends RealtimeEventHandler {
  ...
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug } = {}) {
    super();
    //For close ai proxy server
    // this.defaultUrl = 'wss://api.openai.com/v1/realtime';
    this.defaultUrl = 'https://api.openai-proxy.org/v1/realtime';
  ...
  async connect({ model } = { model: 'gpt-4o-realtime-preview-2024-10-01' }) {
    ...
    if (globalThis.document) {
      ...
      const ws = new WebSocket(
        ...
        'wss://api.openai-proxy.org/v1/realtime?model=gpt-4o-realtime-preview-2024-10-01',
        [],
        {
